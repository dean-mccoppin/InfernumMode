        ...
        public override void AI()
        {
            ...
            if (Timer > WaitTime + ReelbackTime)
            {
                ...
                if (Main.rand.NextBool() && Main.netMode != NetmodeID.Server)
                    ModContent.GetInstance<ProfanedLavaMetaball>().CreateParticle(ModContent.Request<Texture2D>(Texture).Value.CreateMetaballsFromTexture(Projectile.Center - Projectile.velocity * 0.5f, 0f, Projectile.scale * 0.8f, 15f, 170));
            }
        }
